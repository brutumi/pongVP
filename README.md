# Понг - Визуелно
###### Изработен од: *Јован Јакимовски (163088)*
...
*Во DoMove() го поместуваме топчето и приотоа се пази да не излезе од горе или доле (y-оска) на истиот начин објаснет од претходно*
```
    private int DoMove() {
...
И последна е `Pong` класата која е главна класа за формата. Во нејзе ги чуваме двајцата играчи `Player player1, player2` и листа од топчиња `public List<Ball> ballList`. Од оваа класа се повикуваат методоте во другите класи и се загарантирува целосна функционалност.
